...
class Posts extends CI_Controller {
	public function __construct()
    {
        ...
        $this->load->model(array('M_reg_category','M_posts'));
    }
		public function index()
		{
			...
			if($cek == '2'){
				...
				$this->load->view('region/posts_view',$data);
		...
		function json() {
	        ...
	        echo $this->M_posts->jsonRegion($id_Region);
	    }
  ...
  //       	echo "Username is wrong or already taken";
	 //    else{
    	...
    	$cek = $this->M_posts->update(array('id_post'=>$id),$data);
		 	echo "berhasil";
		// }
