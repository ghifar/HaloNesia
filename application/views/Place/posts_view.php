  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
           <!--  <h3><b>Berisi List postingan yang telah dibuat di place ini, lengkap CRUD</b></h3>
            -->
  ...
  $(document).ready(function() {
    $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
              ...
              t = $("#mytable").dataTable({
                  ...
                  processing: true,
                  serverSide: true,
                  ajax: {"url": "<?php echo base_url("Place/posts/json");?>", "type": "POST"},
                  columns: [
                      {
                          "data": "id",
                          "orderable": false
  ...
  function reload_table()
{
 ...
 function edit(id){
  id_place = id;
   $.ajax({
        url : "<?php echo site_url('Place/posts/getPost')?>",
        type: "POST",
        data: {'id':id},
        dataType: "JSON",
        success: function(data)
 ...
 if(confirm('This will delete an Admin from selected place, Are you still want to delete this admin?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Place/posts/delete')?>",
            type: "POST",
            data: {'id':username},
            success: function(data)
            {
