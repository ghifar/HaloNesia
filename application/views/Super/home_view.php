        ...
        <div class="box box-success">
          ...
          <div class="box-body">
             <div class="form-group col-md-12">
                <label for="instansi" class="col-sm-2 control-label">Nama :</label>
...
$('#formEditProfile').submit(function(){
            ...
            var form = $('#formEditProfile')[0]; // You need to use standart javascript object here
            var formData = new FormData(form);
            formData.append('id',id_admin);
            $.ajax({
              url: '<?php echo base_url("Super/Home/update");?>',
              data: formData,
              type: 'POST',
  ...
  $('#form').submit(function(){
            ...
            formData.append('id',id_admin);
            $.ajax({
              url: '<?php echo base_url("Super/Home/update2");?>',
              data: formData,
              type: 'POST',
              // THIS MUST BE DONE FOR FILE UPLOADING
              contentType: false,
